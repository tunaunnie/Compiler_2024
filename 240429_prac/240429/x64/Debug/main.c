...
int main()
{
   ...
   printf("---------------------------------------------------------------------------\n");
    ...
    while ((tn = yylex()) != TEOF) {
        ...
        case TERROR3: printf("error - illegal digit included \n"); break;
        case TERROR2: printf("error - start with digit \n");  break;              // 숫자로 시작하는 에러 처리
        case TERROR:  printf("error - illegal digit included \n");  break;              // illegal 문자 에러 처리
